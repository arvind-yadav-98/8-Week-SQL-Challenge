...
INSERT INTO MEMBERS VALUES
 ...
 with cte_table as (select customer_id, min(order_date) as fod from sales group by customer_id) 
select s.customer_id, m.product_name from sales s join cte_table ct
